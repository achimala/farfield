...
> = {
  ...
  addConversationListener: { status: "internal" },
  "app/list": { status: "internal" },
  archiveConversation: { status: "internal" },
  cancelLoginChatGpt: { status: "internal" },
  ...
  getAuthStatus: { status: "internal" },
  getConversationSummary: { status: "internal" },
  getUserAgent: { status: "internal" },
  getUserSavedConfig: { status: "internal" },
  gitDiffToRemote: { status: "internal" },
  initialize: { status: "internal" },
  interruptConversation: { status: "exposed", commandKind: "interrupt" },
  listConversations: { status: "internal" },
  loginApiKey: { status: "internal" },
  loginChatGpt: { status: "internal" },
  logoutChatGpt: { status: "internal" },
  ...
  newConversation: { status: "exposed", commandKind: "createThread" },
  removeConversationListener: { status: "internal" },
  resumeConversation: { status: "internal" },
  "review/start": { status: "internal" },
  sendUserMessage: { status: "exposed", commandKind: "sendMessage" },
  sendUserTurn: { status: "exposed", commandKind: "sendMessage" },
  setDefaultModel: { status: "internal" },
...
> = {
  ...
  authStatusChange: { status: "exposed", eventKind: "providerStateChanged" },
  ...
  loginChatGptComplete: { status: "exposed", eventKind: "providerStateChanged" },
  ...
  "rawResponseItem/completed": { status: "exposed", eventKind: "threadUpdated" },
  sessionConfigured: { status: "exposed", eventKind: "providerStateChanged" },
